...
export const IssueDetails = () => {
  const { issueId } = useParams(); // Removed projectId if not needed
          ...
          <div>
            ...
            <div className="py-5">
              ...
              <p className="text-gray-400 text-sm mt-3">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit deserunt accusamus sapiente fugiat ea modi minus enim, repellendus ullam architecto.
              </p>
            </div>
            <div className="mt-5">
